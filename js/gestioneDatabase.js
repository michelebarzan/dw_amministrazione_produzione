...
async function getSelectsScegliDatabase()
{
    ...
    else
    {
        ...
        outerContainer.setAttribute("class","importazione-db-tecnico-outer-container");
        outerContainer.setAttribute("id","importazioneDdTecnicoOuterContainer");
        ...
        row.setAttribute("class","importazione-db-tecnico-row");
        ...
        document.getElementById("importazioneDdTecnicoOuterContainer").appendChild(row);document.getElementById("importazioneDdTecnicoOuterContainer").scrollTop = document.getElementById("importazioneDdTecnicoOuterContainer").scrollHeight;
        ...
        button.setAttribute("id","btnImportazioneDdTecnico");
        button.setAttribute("onclick","Swal.close()");
        button.innerHTML='<span>Chiudi</span>';

        document.getElementById("importazioneDdTecnicoOuterContainer").appendChild(button);document.getElementById("importazioneDdTecnicoOuterContainer").scrollTop = document.getElementById("importazioneDdTecnicoOuterContainer").scrollHeight;
...
{
    document.getElementById("gestioneDatabaseContainer").style.overflowY="";
    document.getElementById("gestioneDatabaseContainer").style.paddingRight="";
    ...
    var container=document.getElementById("gestioneDatabaseContainer");
    container.innerHTML="";
...
{
    var checkboxes=document.getElementsByClassName("importazione-db-tecnico-checkbox-svuota-distinte");
...
{
    var checkboxes=document.getElementsByClassName("importazione-db-tecnico-checkbox-aggiorna-anagrafiche");
    for (let index = 0; index < checkboxes.length; index++)
    {
        const checkbox = checkboxes[index];
        checkbox.checked=checked;
...
async function getPopupImportaDatabase(btn)
{
    ...
    for (let index = 0; index < distinte.length; index++)
    {
        ...
        checkbox.setAttribute("class","importazione-db-tecnico-checkbox-svuota-distinte");
        checkbox.setAttribute("type","checkbox");
    ...
    for (let index = 0; index < anagrafiche.length; index++)
    {
        ...
        var checkbox=document.createElement("input");
        checkbox.setAttribute("style","margin-right:10px");
        checkbox.setAttribute("class","importazione-db-tecnico-checkbox-aggiorna-anagrafiche");
        checkbox.setAttribute("type","checkbox");
...
{
    var checkboxesAggiornaAnagrafiche=document.getElementsByClassName("importazione-db-tecnico-checkbox-aggiorna-anagrafiche");
...
async function importaDatabase()
{
    ...
    var tabelle=await getTabelleDbTecnico();
...
function importaTabella(tabella)
{
    return new Promise(function (resolve, reject) 
    {
        $.post("importaTabellaDdTecnico.php",
        {
            tabella
        },
        function(response, status)
...
function getTabelleDbTecnico()
{
    return new Promise(function (resolve, reject) 
    {
        $.get("getTabelleDbTecnico.php",
        function(response, status)
        {
            if(status=="success")
            {
...
function aggiornaAnagrafica(tabella)
{
    return new Promise(function (resolve, reject) 
    {
        $.post("aggiornaAnagraficaDdTecnico.php",
        {
            tabella
        },
        function(response, status)
...
function svuotaDistinta(tabella)
{
    return new Promise(function (resolve, reject) 
    {
        $.post("svuotaDistintaDdTecnico.php",
        {
            tabella
        },
        function(response, status)
...
function getTabellaMateriePrime(button)
{
    ...
    document.getElementById("gestioneDatabaseContainer").style.overflowY="auto";
    document.getElementById("gestioneDatabaseContainer").style.paddingRight="15px";
...
function getTable(table,orderBy,orderType)
{
    ...
    ({
        ...
        editable: true,
        container:'gestioneDatabaseContainer',
        noFilterColumns:['descrizione','um'],
        orderBy:orderBy,
        orderType:orderType,
        readOnlyColumns:["id_materia_prima"],
        noInsertColumns:["id_materia_prima"]
    });
}
